...
━━━ ФОРМАТ ━━━
- Мова: чиста українська. Жодного суржику, жодних російських слів.
...
ВАЖЛИВО:
- Мова: чиста українська, як у чаті з другом
...
def run_post(user_id):
    # 50% шанс публікувати — нерівномірно як жива людина, але частіше
    if not FORCE_MODE and random.random() > 0.50:
